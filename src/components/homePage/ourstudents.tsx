    ...
    <section className="py-28 bg-accent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <span className="text-blue font-bold uppercase tracking-widest text-sm">
            Our Students
          </span>
          <h2 className="font-heading text-5xl md:text-6xl font-black text-navy mt-4">
          ...
          {students.map((student) => (
            ...
            >
              <div className="relative overflow-hidden rounded-3xl aspect-[4/5] shadow-xl">
                ...
                {/* Highlight */}
                <div className="absolute bottom-4 left-4 right-4 bg-white/20 backdrop-blur-md p-3 rounded-xl border border-white/20">
        ...
        <div className="mt-24 bg-white rounded-3xl p-10 text-center shadow-xl">
